<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
                    <li class="nav-item active">
                        <a class="nav-link pl-3" href="{{ route('dashboard.index') }}"><span class="ml-1 item-text">Default</span></a>
                    </li>
                    <li class="nav-item">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="{{ route('user.index')}}"><span class="ml-1 item-text">Show</span>
                  </a>
                </li>
        ...
        <!-- Add the rest of the sidebar content as needed -->
    </nav>
</aside>